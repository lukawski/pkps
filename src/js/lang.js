$(function () {
  var templates = {
    english: " <h2 class='text-center underline'><strong>YOU CAN HELP</strong></h2> \
    <p> \
    ...
    <p>Even the smallest bit counts. From December 1-16,2016 at the PKPS on Robotniczej 9U/2,mon-fri from 10am-2pm, you can start bringing in things for the little ones such as candy, new toys, games, school supplies, clothing, etc. That way, you have a part in giving back. \
    </p> \
    <p> \
    ...
    polish: "<h2 class='text-center underline'><strong>MOŻESZ POMÓC</strong></h2>\
    <div class='col-md-12'>\
